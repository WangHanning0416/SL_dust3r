torchrun --nproc_per_node=4 train.py \
    ...
    --pretrained "/data/hanning/dust3r1/checkpoints/CroCo_V2_ViTLarge_BaseDecoder.pth" \
    --lr 0.0001 --min_lr 1e-06 --warmup_epochs 4 --epochs 60 --batch_size 16 --accum_iter 1 \
    --save_freq 5 --keep_freq 10 --eval_freq 1 \
    --output_dir "/nvme/data/hanning/checkpoints/dust3r_kinectsp_224_inject_pose_nonorm"	  