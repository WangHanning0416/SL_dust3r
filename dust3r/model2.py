    ...
    def _decoder(self, f1, pos1, f2, pos2):
        ...
        for blk1, blk2 in zip(self.dec_blocks, self.dec_blocks2):
            ...
            if i < 6:
                ...
                os.makedirs(os.path.join(self.attn_save_dir, f"layer_{i}"), exist_ok=True)
                save_path_f1 = os.path.join(self.attn_save_dir, f"layer_{i}/img1_to_img2_attn.npy")
                save_path_f2 = os.path.join(self.attn_save_dir, f"layer_{i}/img2_to_img1_attn.npy")
