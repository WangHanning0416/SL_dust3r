...
class AsymmetricCroCo3DStereo (
    ...
    def _decoder(self, f1, pos1, f2, pos2):
        ...
        for blk1, blk2 in zip(self.dec_blocks, self.dec_blocks2):
            ...
            # save_attn_map(attn_map1, attn_map2, self.attn_save_dir, j)
            # if i < 6:
            #     f1 , attn_map1 = self.pattern_fusors1[i](f1, pattern_embed, pos1, pos_embed)
            #     f2 , attn_map2 = self.pattern_fusors2[i](f2, pattern_embed, pos2, pos_embed)
            #     final_output.append((f1, f2))
            #     i += 1
            final_output.append((f1, f2))
