...
import PIL.Image
from dust3r.model2 import load_model
...
CONFIG = {
    "model_weight_path": "/nvme/data/hanning/checkpoints/dust3r_rgb_224/checkpoint-best.pth",
    "resolution": 224,  
...
def process_scene(model, scene_name, image_pairs, intrinsics):
    ...
    summary_path = "/data/hanning/SL_dust3r/evaluation/result_scannetpp.csv"
    print(loss)
...
def main():
    ...
    scenes = ["0d41f3a279", "85251de7d1", "f7d34e6706", "aea84db0de", "fb9b4c2f15","d9c781301e","7543973e1a","f7da3f0714"]
    for scene_name in scenes:
        image_pairs = []
        idx = 0
        while True and idx < 500:
            # img1_path = f"/nvme/data/hanning/datasets/Scannetpp/scannetpp_kinectsp/{scene_name}/frame_{idx:05d}0.jpg"
            # img2_path = f"/nvme/data/hanning/datasets/Scannetpp/scannetpp_kinectsp/{scene_name}/frame_{idx+1:05d}0.jpg"
            img1_path = f"/data/yuzheng/data/scannetpp_v2/scannetpp_processed/{scene_name}/images/frame_{idx:05d}0.jpg"
            img2_path = f"/data/yuzheng/data/scannetpp_v2/scannetpp_processed/{scene_name}/images/frame_{idx+1:05d}0.jpg"
            depth1_path = f"/data/yuzheng/data/scannetpp_v2/scannetpp_processed/{scene_name}/depth/frame_{idx:05d}0.png"
            depth2_path =  f"/data/yuzheng/data/scannetpp_v2/scannetpp_processed/{scene_name}/depth/frame_{idx+1:05d}0.png"
